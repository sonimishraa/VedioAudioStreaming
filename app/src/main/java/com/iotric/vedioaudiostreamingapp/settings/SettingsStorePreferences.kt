package com.iotric.vedioaudiostreamingapp.settings

import android.content.Context
import android.content.SharedPreferences
import android.os.Build
import androidx.core.content.edit
import com.iotric.vedioaudiostreamingapp.meeting.MeetingViewMode
...
class SettingsStorePreferences(context: Context) {
    ...
    inner class MultiCommitHelper {
        ...
        fun setVideoResolutionWidth(value: Int) =
            apply { editor.putInt(VIDEO_RESOLUTION_WIDTH, value) }
        ...
        fun setShowNetworkInfo(value: Boolean) =
            apply { editor.putBoolean(SHOW_NETWORK_INFO, value) }
        ...
        fun setLastUsedMeetingUrl(value: String) =
            apply { editor.putString(LAST_USED_MEETING_URL, value) }
        ...
        fun setLogLevel100msSdk(value: String) =
            apply { editor.putString(LOG_LEVEL_100MS_SDK, value) }

        fun setLogLevel100msSdk(value: HMSLogger.LogLevel) =
            apply { editor.putString(LOG_LEVEL_100MS_SDK, value.toString()) }

        fun setSubscribeDegradation(value: Boolean) =
            apply { editor.putBoolean(SUBSCRIBE_DEGRADATION, value) }
